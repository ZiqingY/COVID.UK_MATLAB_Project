...
if cases == 1;
    ...
    kt = (1 + (fatiguesize1-1)*normcdf(t,fatiguemean1,fatiguesig1))*kappa1.*(t<=129) + (1 + (fatiguesize2-1)*normcdf(t,fatiguemean2,fatiguesig2))*kappa2.*(t>129 & t<=259) + (1 + (fatiguesize3-1)*normcdf(t,fatiguemean3,fatiguesig3))*kappa3.*(t>259)
end;
